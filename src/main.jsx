...
const cards = [
  ...
  ...members.map((member) => ({
    ...
    image:
      member === "Seungmin"
        ? "/cards/Fans/seungmin.jpg"
        : `/cards/Fans/${fileNames[member]}.jpg`,
  })),
];
...
function App() {
  ...
  const visible = useMemo(() => {
    ...
    return currentCards.filter((card) => {
      ...
      const matchesSearch =
        !query ||
        `${card.member} ${card.type} ${card.category}`
          .toLowerCase()
          .includes(query);
  ...
  const activeComeback = comebacks.find(
    (item) => item.id === comeback
  );
  ...
  return (
    <div className="app">
      <header className="hero">
        ...
        <p>
          keep track of what you own, what you're missing,
          and every comeback in your binder.
        </p>
      </header>
        ...
        <section className="collection">
          ...
          <div className="tools">
            <input
              ...
              placeholder="search member or card type..."
            />

            <div>
              {["all", "owned", "missing"].map(
                (item) => (
                  <button
                    key={item}
                    className={
